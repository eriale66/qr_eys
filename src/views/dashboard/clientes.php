                ...
                <td class="qr-cell">
                  ...
                  if (file_exists($filePath)): ?>
                    <div class="qr-container">
                      <a href="<?= htmlspecialchars($qrPath, ENT_QUOTES, 'UTF-8') ?>" download="<?= htmlspecialchars($c['nombre'], ENT_QUOTES, 'UTF-8') ?>.png" title="Descargar QR" class="qr-download">
                        <img src="<?= htmlspecialchars($qrPath, ENT_QUOTES, 'UTF-8') ?>" alt="QR <?= htmlspecialchars($c['nombre']) ?>" class="qr-image">
